...
export function RequestAccessPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 relative bg-brand-900" style={{ backgroundImage: 'url(/images/fondo_login.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="relative z-10 w-full max-w-lg rounded-2xl overflow-hidden border border-gold-400/20 shadow-[0_24px_70px_rgba(10,17,40,0.55)] bg-gradient-to-br from-brand-800 via-brand-900 to-[#071024]">
        <div className="p-6 sm:p-8">
          ...
          {done ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" disabled={isSubmitting} className="w-full h-11 bg-gradient-to-r from-brand-600 via-brand-700 to-brand-800 hover:from-brand-500 text-white font-semibold border border-gold-400/20">
